...
void main() {
  runApp(
    const MaterialApp(debugShowCheckedModeBanner: false, home: Womencategory()),
  );
}
...
class _WomencategoryState extends State<Womencategory> {
  ...
  final List<Product> allPerfumes = [
    ...
    Product(
      ...
      subtitle: "Classic floral fragrance",
      price: "\$120.00",
      image: "assets/Gaultier Divine.jpg",
      type: "Luxury",
    ),
    Product(
      title: "Thanks u next.jpg",
      subtitle: "Classic floral fragrance",
      price: "\$160.00",
      image: "assets/Thanks u next.jpg",
      type: "Luxury",
    ),
    Product(
      title: "valentino",
