...
// --- HOMEPAGE ---
class ManProduct extends StatelessWidget {
...
const List<Product> ManProducts = [
  Product(
    name: 'chanel strong',
    imagePath: 'assets/chanel strong.jpg',
    price: '\$120.00',
  ),
  Product(name: 'jean paul',
   imagePath: 'assets/jean paul.jpg',
    price: '\$145.00'),
  Product(
    name: 'strong with u',
    imagePath: 'assets/stronger with u.jpg',
    price: '\$160.00',
  ),
  Product(
    name: 'savage dior',
    imagePath: 'assets/savage dior.jpg',
    price: '\$115.00',
  ),
  Product(name: 'tom ford', 
  imagePath: 'assets/tom ford.jpg', 
  price: '\$130.00'),
              ...
              child: Padding(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      ProductCard(product: ManProducts[index]),
                ),
              ),
            ),
          ],
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (context, List<Map<String, dynamic>> wishlist, _) {
        bool isLiked = WishlistExtension(globalWishlist).containsProduct(widget.product);
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (isLiked) {
                        WishlistExtension(globalWishlist).removeProduct(widget.product);
                      } else {
                        WishlistExtension(globalWishlist).addProduct(widget.product);
                      }
                    },
                    child: Container(
